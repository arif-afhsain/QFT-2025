...
\usepackage{lmodern} % Improved version of Comput
...
\newcommand{\ClassHeader}{
  ...
  \else\ifnum\value{page}<16
    \textit{Review of Special Relativity} % Class 2
  \else\ifnum\value{page}<22
    \textit{Preliminary QFT} % Class 3
  \else\ifnum\value{page}<32
    \textit{Poincar\'e Algebra} % Class 4
  \else\ifnum\value{page}<38
    \textit{GR basics for Classical Field} % Class 5
  \else\ifnum\value{page}<44
    \textit{Lie Derivative} % Class 6
  \else\ifnum\value{page}<49
    \textit{Covariant Derivative} % Class 7
  \else\ifnum\value{page}<55
    \textit{Classical Field Theory} % Class 8
  \else\ifnum\value{page}<60
    \textit{Gauge Theory} % Class 9
  \else\ifnum\value{page}<68
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\linewidth]{figures/C01_1.png}
\caption*{}
\end{figure}
\vspace{-1.5cm}
\subsection*{Massless}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.45\linewidth]{C01_2.png}
\caption*{}
\end{figure}
\vspace{-1cm}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\linewidth]{C01_3.png}
\caption*{}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\linewidth]{C02_1.png}
\caption*{}
\end{figure}
\vspace{-0.9cm}
\noindent
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\linewidth]{C02_2.png}
\caption*{}
\end{figure}
\vspace{-0.9cm}
\noindent
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{C02_3.png}
\caption*{}
\end{figure}
\vspace{-0.9cm}
\noindent
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\linewidth]{C02_4.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\linewidth]{C02_5.png}
\caption*{}
\end{figure}
\vspace{-1cm}
\begin{itemize}
...
\centering
\includegraphics[width=\linewidth]{C02_6.png}
\end{minipage}
\end{figure}
% ---
\textbf{Significance:}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\linewidth]{C03_1.png}
\caption*{}
\end{figure}
\vspace{-1.5cm}
\begin{itemize}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.3\linewidth]{C03_2.png}
\caption*{}
\end{figure}
\vspace{-1.6cm}
% ---
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\linewidth]{C04_1.png}
\caption*{}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\linewidth]{C04_2.png}
\caption*{}
\end{figure}
\begin{tcolorbox}[ title=\textbf{Note}]
...
\begin{figure}[H]
\centering
\includegraphics[width=0.4\linewidth]{figures/C05_1.png}
\caption*{}
\vspace{-1em}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.3\linewidth]{figures/C05_2.png}
\caption*{}
\end{figure}
\vspace{-1.5cm}
\begin{align*}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.45\linewidth]{figures/C05_3.png}
\caption*{}
\end{figure}
\vspace{-1.5cm}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.3\linewidth]{figures/C05_4.png}
\caption*{}
\end{figure}
\vspace{-2cm}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\linewidth]{C06_1.png}
\caption*{}
\end{figure}
\vspace{-1cm}
\noindent
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\linewidth]{figures/C06_2.png}
\caption*{}
\end{figure}
\vspace{-1cm}
\noindent 
...
\begin{figure}[H]
\centering
\includegraphics[width=0.3\linewidth]{C06_3.png}
\caption*{}
\end{figure}
\vspace{-1cm}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.35\linewidth]{C06_4.png}
\caption*{}
\end{figure}
\vspace{-1cm}
\end{tcolorbox}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.4\linewidth]{C06_5.png}
\caption*{}
\end{figure}
\vspace{-1cm}
...
\end{align*}
This tells us how the vector field $W$ changes when dragged along the flow generated by $V$. Therefore,
\begin{align*}
...
\begin{align*}
\left[ \mathfrak{L}_{\hat{V}}, \mathfrak{L}_{\hat{W}}\right] = 
...
\begin{framed}
\noindent
\textbf{Exercise:}\quad Find the Lie derivative of a tensor field 
\begin{align*}
    \mathfrak{L}_{\hat{\nu}} \tilde{T^a_b}
\end{align*}
\end{framed}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.4\linewidth]{figures/C07_1.png}
\caption*{}
\end{figure}
\vspace{-1cm}
\begin{itemize}
...
\subsubsection*{Solution: Introduce a Connection}
...
\partial_d' M^c{}_b = 0,
\]
but this is not true in general coordinates.

Instead, we add a correction term (the connection $\Gamma$) to the derivative:
\[
\nabla_a v^b = \partial_a v^b + \Gamma_a {}^b{}_c v^c.
\]
This ensures that the transformation law works out correctly.

More generally, we write
\[
\nabla_a = \partial_a + A_a,
\]
where $A_a$ is the connection (called ``connexion'' in older books).
...
\begin{align*}
\mathfrak{L}_V W_a &= -\left(V^c~\partial_c W_a + W_c\, \partial_a V^c)\right) \\
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/C08_1.png}
    ...
    \begin{subfigure}[t]{0.4\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/C08_2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{C08_3.png}
    \caption*{}
\end{figure}
\vspace{-1.5cm}
\begin{align*}
...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.35\textwidth}
        \includegraphics[width=\linewidth]{figures/C08_5.png}
    \end{minipage}
    % Space-like Space
    \begin{minipage}[t]{0.6\textwidth}
    \vspace{-3.5cm}
    ...
    \hfill
    \begin{minipage}[t]{0.35\textwidth}
        \includegraphics[width=\linewidth]{figures/C08_4.png}
    \end{minipage}
    % Null-like Space
    \begin{minipage}[t]{0.6\textwidth}
    \vspace{-3cm}
    ...
    \hfill
    \begin{minipage}[t]{0.35\textwidth}
        \includegraphics[width=\linewidth]{figures/C08_6.png}
    \end{minipage}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\linewidth]{figures/C09_1.png}
    \caption*{}
\end{figure}
\vspace{-1.5cm}
Therefore,
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{figures/C09_2.png}
    \caption*{}
\end{figure}
\vspace{-1cm}
\begin{tcolorbox}[title=Notes]
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\linewidth]{figures/C09_3.png}
    \caption*{}
\end{figure}
\vspace{-1.5cm}
\begin{align*}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.1\linewidth]{figures/C10_1.png}
    \caption*{}
\end{figure}
% \vspace{}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{figures/C10_3.png}
    \caption*{}
\end{figure}
% \vspace{}
For Hamiltonian:
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/scatter.png}
\end{figure}
\vspace{-0.5cm}
That is: 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{figures/C10_4.png}
    \caption*{}
\end{figure}
\vspace{-2cm}
\begin{align*}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{C11_2.png}
    \caption*{}
\end{figure}
\vspace{-1cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{C11_1.png}
    \caption*{}
\end{figure}
\vspace{-1cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\linewidth]{C11_3.png}
    \caption*{}
\end{figure}
\vspace{-1.5cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{C11_4.png}
    \caption*{}
\end{figure}
\vspace{-1.5cm}
\begin{tcolorbox}
...
In interacting theory, it suffices to know the 2-point linear function $J(x)$ to get the Green's function.
 \begin{figure}[H]
     \centering
         \includegraphics[width=0.4\linewidth]{figures/C11_5.png}
         \caption*{Linear}
     \end{figure}
     If it's not linear
      \hfill
     \begin{figure}[H]
         \centering
         \includegraphics[width= 0.4\linewidth]{figures/C11_6.png}
         \caption*{Non-linear}
     \end{figure}
      \vspace{-0.5cm}
...
\begin{align*}
    ...
    \phi^3 \mathbb{I} \rightarrow \left( \phi + \frac{\hbar}{i} \frac{\delta}{\delta J}\right) \phi = \phi^2 + \frac{\hbar}{i} \frac{\delta \phi}{\delta J} \\
\end{align*}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\linewidth]{figures/C13_1.png}
    \caption*{}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{figures/C13_2.png}
    \caption*{}
    % \label{fig:placeholder}
\end{figure}
\vspace{-1.5cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{figures/C13_3.png}
    \caption*{}
    % \label{fig:placeholder}
\end{figure}
\vspace{-1.3cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.15\linewidth]{figures/C13_4.png}
    \caption*{}
    % \label{fig:placeholder}
\end{figure}
\vspace{-1.5cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\linewidth]{figures/C13_5.png}
    \caption*{}
    % \label{fig:placeholder}
\end{figure}
\vspace{-1.5cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.2\linewidth]{figures/C13_6.png}
    \caption*{}
    % \label{fig:placeholder}
\end{figure}
\vspace{-2cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\linewidth]{figures/C13_7.png}
    \caption*{}
    % \label{fig:placeholder}
\end{figure}
\vspace{-2cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.15\linewidth]{figures/C13_8.png}
    \caption*{}
    % \label{fig:placeholder}
\end{figure}
% \vspace{-2.3cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/C14_01.png}
    \caption*{}
    % \label{fig:placeholder}
\end{figure}
\vspace{-1.2cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.2\linewidth]{figures/C14_01.png}
    \caption*{}
    % \label{fig:placeholder}
\end{figure}
\vspace{-0.5cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\linewidth]{figures/C14_03.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\linewidth]{figures/C14_04.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/C14_05.png}
    \caption*{}
    % \label{fig:placeholder}
\end{figure}
\vspace{-1cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/C14_06.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.2\linewidth]{figures/C14_07.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\linewidth]{figures/C14_08.png}
    \caption*{}
    \label{fig:placeholder}
\end{figure}
\vspace{-0.5cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\linewidth]{figures/C14_09.png}
    \caption*{}
    \label{fig:placeholder}
\end{figure}
\vspace{-1.5cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\linewidth]{figures/C14_10.png}
    \caption*{}
    \label{fig:placeholder}
\end{figure}
\vspace{-1cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\linewidth]{figures/C14_11.png}
    \caption*{}
    \label{fig:placeholder}
\end{figure}
\vspace{-1cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\linewidth]{figures/C14_12.png}
    \caption*{}
    \label{fig:placeholder}
\end{figure}
\vspace{-1cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/C14_13.png}
    \caption*{}
    \label{fig:placeholder}
\end{figure}
\vspace{-2cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/C14_14.png}
    \caption*{}
    \label{fig:placeholder}
\end{figure}
\vspace{-1.5cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{figures/C14_15.png}
    \caption*{}
    \label{fig:placeholder}
\end{figure}
\vspace{-1.5cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/C14_16.png}
    \caption*{}
    \label{fig:placeholder}
\end{figure}
\vspace{-1.5cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/C14_17.png}
    \caption*{}
    \label{fig:placeholder}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/C14_18.png}
    \caption*{}
    \label{fig:placeholder}
\end{figure}
\vspace{1cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/C14_19.png}
    \caption*{}
    \label{fig:placeholder}
\end{figure}
\begin{framed}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.2\linewidth]{figures/C14_20.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{figures/C14_21.png}
    \caption*{}
    \label{fig:placeholder}
\end{figure}
\vspace{-1.2cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/C15_1.png}
    %\caption*{}
    %\label{fig:placeholder}
\end{figure}
\vspace{-1cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/C15_2.png}
\end{figure}
...
\]
where $\hat{A}\phi_i = \lambda_i \phi_i$.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/C16_1.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{figures/C16_2.png}
\end{figure}
It is 1PR because it can be cut into two pieces and then form 1PI. Whereas 1PI:
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{figures/C16_3.png}
\end{figure}
\vspace{-0.5cm}
1PI cannot be cut at the middle to produce another 1PI.
\begin{figure}
    \centering
    \includegraphics[width=0.3\linewidth]{figures/C16_4.png}
\end{figure}
There are 5 internal lines here, among which only two of them are independent ($I_2,\,I_3$). So, the number of loops = 2 \\

Now,
\begin{align*}
& \frac{\delta \phi_m}{\delta J_k} \frac{\delta J_k}{\delta \phi_n} = \delta_{mn} \qquad \text{and,}
\\
\int d^Dy &\, \frac{\delta \phi_m(x)}{\delta J(y)} \frac{\delta J(y)}{\delta \phi_n(z)} = \delta^D(x-z) \qquad \text{hence,}
\\\\
\therefore &\frac{\delta \phi_m}{\delta J_k} \cdot 
\frac{\delta J_k}{\delta \phi_n}
= \delta_{mn}
\end{align*}
% Hence,
% \[
% \frac{\delta^2 W[J]}{\delta J_m \, \delta J_k} \cdot 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\linewidth]{figures/C16_5.png}
\end{figure}
\begin{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{figures/C16_5.5.png}
\end{figure}
\vspace{-0.5cm}
\begin{align*}
...
\]
As partial derivatives commute, ordering is not necessary.  
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\linewidth]{figures/C16_6.png}
\end{figure}
The derivative of $\Gamma$ :
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{figures/C16_7.png}
\end{figure}
For 4-points:
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{figures/C16_8.png}
\end{figure}
\newpage
Now,
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/C16_9.png}
\end{figure}
\vspace{-0.5cm}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/C16_10.png}
\end{figure}
\vspace{-0.5cm}
\noindent\textbf{Detour:}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/C16_11.png}
\end{figure}
Hence,
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/C16_12.png}
\end{figure}
For 4-point, the diagrams would be like -
\begin{figure}[H]
    \centering
    \includegraphics[width=0.66\linewidth]{figures/C16_13.png}
\end{figure}
...
\stepcounter{section}
\renewcommand{\thesection}{\arabic{section}}
\fancysection{(\textit{\textbf{Class-17})} Lecture \textbf{14} : Sat, Aug 30, 2025}{\textbf{\textit{Dimentional Regularization}}}
...
Here, $m$ is identified as the pole in the Green’s function.  

In presence of interaction, one sees that the pole is getting shifted from
\[
m^2 \;\to\; m^2 + V''(\bar{\phi})
\]
call the Archimedean bath. \\
Using the expansion:
\[
...
\[
\Gamma^{(1)} = S + \frac{\hbar}{2i} \, \mathcal{O}
\]

where
\[
\mathcal{O} = \;\; \text{(loop diagrams placeholder)} 
\]
...
\stepcounter{section}
\renewcommand{\thesection}{\arabic{section}}
\fancysection{(\textit{\textbf{Class-20})} Lecture \textbf{17} : Sat, Sep 13, 2025}{\textbf{\textit{Calculating Effective Action \& Potential}}}
...
\subsubsection*{Commutator Identity}
\[
[A, BC] = [A,B]C + B[A,C]
\]
...
\subsubsection*{Commutation vs Anticommutation}
